...
An example output file “TmPy.example_input_file.out.txt” corresponding to the example input file is given. It was obtained using all the default parameters.
